                ...
                <div class="bg-gray-900 border border-gray-800 p-8">
                    ...
                    <div class="mt-6">
                        ...
                        <a
                            ...
                            class="mt-6 w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-800 border border-gray-700 text-gray-300 hover:bg-gray-700 transition-colors"
                        >
