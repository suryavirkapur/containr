...
const Settings: Component = () => {
    ...
    const handleDeleteGithubApp = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                throw new Error('failed to delete github app');
            }
                    ...
                    <section class="border border-neutral-200 p-6">
                        ...
                        <Show when={!githubApp.loading}>
                                            ...
                                            <div class="space-y-2">
                                                {githubApp()?.installations.map((install) => (
                                                    <div class="flex items-center justify-between py-2 px-3 bg-neutral-50">
                                                        <div>
                                                            <span class="text-sm text-black font-mono">{install.account_login}</span>
                            ...
                            <Show when={!githubApp()?.configured}>
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm text-neutral-600">create a github app to deploy private repositories</p>
                                        <p class="text-xs text-neutral-400 mt-1">you'll create an app and install it on your repos</p>
                                    </div>
                                    <button
