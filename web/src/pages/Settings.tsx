...
const appearanceAccentOptions: ColorScheme[] = [
	"blue",
	"green",
	"orange",
	"red",
];
const appearanceRoundnessOptions: Roundness[] = [
	"none",
	"slight",
	"medium",
	"full",
		...
		<div>
			...
			<Card class="mb-8">
				<CardHeader>
					...
					<CardDescription>
						client-side theme settings for this browser session. changes apply
						immediately.
					</CardDescription>
				</CardHeader>
						...
						<div class="grid grid-cols-2 gap-2">
							<For each={appearanceRoundnessOptions}>
								{(roundness) => (
									<Button
										variant={
											theme().roundness === roundness ? "primary" : "outline"
										}
										size="sm"
								...
								<button
									...
									disabled={
										...
										(!settings()?.base_domain &&
											!settings()?.storage_public_hostname)
									}
