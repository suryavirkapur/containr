    ...
    return (
        <div>
            <div class="flex justify-between items-start mb-8">
                <div>
                    <h1 class="text-2xl font-serif text-black">volumes</h1>
                    <p class="text-neutral-500 mt-1 text-sm">
                        browse persistent volume data for managed services and apps
                    </p>
                </div>
                <button
                    onClick={() => refetch()}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <Show when={selectedId()}>
                        <ContainerMonitor containerId={selectedId()} defaultTab="volumes" />
                    </Show>
                    <Show when={!selectedId()}>
