      ...
      <Show when={!bucket.loading && bucket()}>
          ...
          <div class="p-5 space-y-4">
            <div>
              ...
              <div class="flex items-center gap-2">
                ...
                <button
                  onClick={() =>
                    copyToClipboard("endpoint", bucket()!.endpoint)
                  }
            ...
            <div>
              ...
              <div class="flex items-center gap-2">
                ...
                <button
                  onClick={() =>
                    copyToClipboard("access", bucket()!.access_key)
                  }
                  class="px-3 py-2 text-xs border border-neutral-300 text-neutral-500 hover:text-black"
                >
        ...
        <div class="mt-6 p-4 border border-dashed border-neutral-200 text-center">
          <p class="text-xs text-neutral-400">
            the secret key is only shown once during bucket creation. if you've
            lost it, you'll need to delete this bucket and create a new one.
          </p>
        </div>
      </Show>
    </div>
