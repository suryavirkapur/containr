        ...
        <div class="border border-neutral-200 p-4 mb-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        onInput={(e) => updateField('port', parseInt(e.currentTarget.value) || 8080)}
                        class="w-full px-2 py-1.5 bg-white border border-neutral-300 text-black placeholder-neutral-400 focus:outline-none focus:border-black text-sm"
                        placeholder="8080"
                    />
                </div>
                ...
                <div class="col-span-2">
                    <label class="block text-neutral-600 text-xs mb-1">
                        docker image <span class="text-neutral-400">(leave empty to use built image)</span>
                    </label>
                    <input
                        type="text"
                ...
                <div>
                    ...
                    <input
                        ...
                        onInput={(e) => updateField('replicas', parseInt(e.currentTarget.value) || 1)}
                        min="1"
                        max="10"
                        class="w-full px-2 py-1.5 bg-white border border-neutral-300 text-black placeholder-neutral-400 focus:outline-none focus:border-black text-sm"
                    />
                            ...
                            <For each={availableDependencies()}>
                                {(dep) => (
                                    <button
                                        ...
                                        class={`px-2 py-0.5 text-xs border ${props.service.depends_on.includes(dep)
            ...
            <Show when={showAdvanced()}>
                <div class="mt-3 pt-3 border-t border-neutral-100 grid grid-cols-2 gap-4">
                    {/* memory limit */}
                    <div>
                        <label class="block text-neutral-600 text-xs mb-1">memory (mb)</label>
                        <input
                            type="number"
                    ...
                    {/* health check path */}
                    <div>
                        <label class="block text-neutral-600 text-xs mb-1">health check path</label>
                        <input
                            type="text"
                            value={props.service.health_check_path}
                            onInput={(e) => updateField('health_check_path', e.currentTarget.value)}
                            class="w-full px-2 py-1.5 bg-white border border-neutral-300 text-black placeholder-neutral-400 focus:outline-none focus:border-black text-sm"
                            placeholder="/health"
                        />
                    </div>
                    ...
                    {/* restart policy */}
                    <div>
                        <label class="block text-neutral-600 text-xs mb-1">restart policy</label>
                        <select
                            value={props.service.restart_policy}
                            onChange={(e) => updateField('restart_policy', e.currentTarget.value)}
