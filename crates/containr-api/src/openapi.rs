...
#[openapi(
    ...
    paths(
        ...
        databases::configure_proxy,
        databases::create_pitr_base_backup,
        databases::create_restore_point,
        databases::recover_database,
    ...
    components(
        schemas(
            ...
            apps::ServiceMountRestoreResponse,
            // deployments
            ...
            databases::ConfigurePitrRequest,
            databases::ConfigureProxyRequest,
            databases::CreateBaseBackupRequest,
            databases::BaseBackupResponse,
            databases::CreateRestorePointRequest,
            databases::RestorePointResponse,
            databases::RecoverDatabaseRequest,
            databases::RecoverDatabaseResponse,
            databases::ExportRequest,
