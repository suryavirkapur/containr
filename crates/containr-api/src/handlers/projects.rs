...
) -> Result<(StatusCode, Json<apps::AppResponse>), (StatusCode, Json<ErrorResponse>)> {
...
pub async fn get_project_metrics(
    ...
    headers: HeaderMap,
    Path(id): Path<Uuid>,
) -> Result<Json<Vec<apps::AppMetricsResponse>>, (StatusCode, Json<ErrorResponse>)> {
...
pub async fn backup_service_mounts(
    ...
    apps::backup_service_mounts(State(state), headers, Path((id, service_name))).await
}
...
pub async fn restore_service_mounts(
    ...
    Path((id, service_name)): Path<(Uuid, String)>,
    multipart: Multipart,
) -> Result<Json<apps::ServiceMountRestoreResponse>, (StatusCode, Json<ErrorResponse>)> {
    apps::restore_service_mounts(State(state), headers, Path((id, service_name)), multipart).await
}
...
pub async fn list_deployments(
    ...
    headers: HeaderMap,
    Path(id): Path<Uuid>,
) -> Result<Json<Vec<deployments::DeploymentResponse>>, (StatusCode, Json<ErrorResponse>)> {
...
) -> Result<Json<deployments::DeploymentResponse>, (StatusCode, Json<ErrorResponse>)> {
    deployments::get_deployment(State(state), headers, Path((project_id, id))).await
}
...
) -> Result<(StatusCode, Json<deployments::DeploymentResponse>), (StatusCode, Json<ErrorResponse>)>
{
...
{
    deployments::rollback_deployment(State(state), headers, Path((project_id, id)), body).await
}
...
pub async fn get_deployment_logs(
    ...
    deployments::get_deployment_logs(State(state), headers, Path((project_id, id)), query).await
}
...
pub async fn get_certificate(
    ...
    headers: HeaderMap,
    Path(id): Path<Uuid>,
) -> Result<Json<Vec<certificates::CertificateResponse>>, (StatusCode, Json<ErrorResponse>)> {
...
) -> Result<Json<certificates::ReissueResponse>, (StatusCode, Json<ErrorResponse>)> {
    certificates::reissue_certificate(State(state), headers, Path(id), body).await
}
